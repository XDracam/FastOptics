...
public class LensSourceGeneratorForMethodsTests
{
    private const string SourceText = 
        ...
        public partial static class TestClass { 
            [Lens(".Name.First")]
            public static partial ILens<Person, string> FirstNameLens();
        }
        """;
    ...
    {
        var generator = new LensSourceGeneratorForMethods();

        var driver = CSharpGeneratorDriver.Create(generator);

        var compilation = CSharpCompilation.Create(nameof(LensSourceGeneratorForMethodsTests),
